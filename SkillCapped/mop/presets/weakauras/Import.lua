...
local waNames = {
    ...
    ["BBP_NameplateResourceMoP"] = "BBP-NameplateResourceMoP",
    ["SkillCapped_ClassBuffs"] = "Skill Capped MoP Classic Class Buffs WeakAura Pack",
    ["SkillCapped_BuffsAndDebuffs"] = "Skill Capped MoP Classic Defensive Buffs & Debuffs WeakAura Pack",
    ["SkillCapped_EnemyCDs"] = "Skill Capped MoP Classic Enemy CDs WeakAura Pack",
    ["SkillCapped_MissingBuffs"] = "Skill Capped MoP Classic Missing Buffs WeakAura Pack",
    ["SkillCapped_CC"] = "Skill Capped MoP Classic CC WeakAura Pack",
    ["Drink"] = "Drink MoP",
    ["Enemy_Battleground_CDs"] = "Skill Capped MoP Classic Enemy Battleground CDs WeakAura Pack",
    ["MMRDisplay"] = "MMR Display",
    ["PartyAutoMarker"] = "[Arena] Ultimate Party Automarker",
    ["InternalCDTracker"] = "Skill Capped MoP Classic Internal Cooldown Tracker",
}
...
local waNamesPvP = {
    ...
    ["sArena_MoP_DoT_Tracker"] = SC.scIcon.."Arena DoTs",
    ...
    ["BBP_NameplateResourceMoP"] = "BBP NameplateResourceMoP",
    ["SkillCapped_CC"] = SC.scIcon.."MoP Classic CC WeakAura Pack",
    ["MMRDisplay"] = "MMR Display",
    ["PartyAutoMarker"] = "[Arena] Ultimate Party Automarker",
    ["InternalCDTracker"] = SC.scIcon.."MoP Classic ICD Tracker",
}
