...
- Minor improvements added 
    - new Midnight traits are enabled and count statistic is shown
    - overlapping in traits frame resolved
- Now content for 2v2, 3v3, blitz and RBG PvP added
- Enchantment source item retrieval via wowhead
    - enchant_db stores now already retrieved source data

### 1.4.0
- New daemon hunter spec for Midnight added
