...
function ClassListFrameMixin:OnLoad()
	local tabConfig = {}
	tabConfig[1] = {title = MURLOKEXPORT_TAB_MYTHIC_PLUS, atlas = "GM-icon-difficulty-mythicSelected"}
	tabConfig[2] = {title = MURLOKEXPORT_TAB_SOLO_PVP, atlas = "UI-HUD-UnitFrame-Player-PVP-FFAIcon"}
	tabConfig[3] = {title = MURLOKEXPORT_TAB_2V2_PVP, atlas = "UI-EventPoi-pvp"}
	tabConfig[4] = {title = MURLOKEXPORT_TAB_3V3_PVP, atlas = "pvptalents-warmode-swords"}
	tabConfig[5] = {title = MURLOKEXPORT_TAB_BLITZ_PVP, atlas = "icon_trackedbuffs"}
	tabConfig[6] = {title = MURLOKEXPORT_TAB_RBG_PVP, atlas = "ColumnIcon-FlagCapture2"}
...
function ClassListFrameMixin:TabOnClick(tab)
	local tabToContent = {'mm+', 'solo', '2v2', '3v3', 'blitz', 'rbg'}
