...
L["!!Main Addon Description"] = "Предоставляет визуальные, звуковые и текстовые уведомления о времени восстановления, усилениях и многом другом."
L["ABSORBAMT"] = "Сумма поглощающего щита"
L["ABSORBAMT_DESC"] = "Проверяет общее количество поглощающих щитов, имеющихся у объекта"
L["ACTIVE"] = "%d Активен"
L["ADDONSETTINGS_DESC"] = "Настройте общие параметры дополнения(аддона)."
L["AIR"] = "Воздух"
L["ALLOWCOMM"] = "Разрешить обмен информацией в игре"
L["ALLOWCOMM_DESC"] = "Разрешите другим пользователям TellMeWhen отправлять вам данные. Вам потребуется перезагрузить пользовательский интерфейс или выйти из системы, прежде чем вы сможете получать какие-либо данные."
L["ALLOWVERSIONWARN"] = "Уведомлять о новых версиях"
L["ALPHA"] = "Прозрачность"
L["ANCHOR_CURSOR_DUMMY"] = "Модель анкера курсора TellMeWhen"
L["ANCHOR_CURSOR_DUMMY_DESC"] = "Эта модель поможет вам расположить значки, привязанные к курсору. Привязка групп к курсору может быть полезна для значков, проверяющих объекты на 'mouseover'. Из-за ошибки Blizzard анимация перезарядки не работает при движении, поэтому вам, вероятно, следует отключить ее для значков, привязанных к курсору. |cff7fffffЩелкните левой кнопкой мыши и перетащите|r, чтобы переместить модель."
L["ANCHORTO"] = "Привязать к"
L["ANIM_ACTVTNGLOW"] = "Значок: граница активации"
L["ANIM_ACTVTNGLOW_DESC"] = "Отображает на значке рамку активации заклинания Blizzard."
L["ANIM_ALPHASTANDALONE"] = "Прозрачность"
L["ANIM_ALPHASTANDALONE_DESC"] = "Установите прозрачность анимации."
L["ANIM_ANCHOR_NOT_FOUND"] = "Не удалось найти фрейм с именем %q, к которому можно привязать анимацию. Этот фрейм не используется текущим видом значка?"
L["ANIM_ANIMSETTINGS"] = "Настройки"
L["ANIM_ANIMTOUSE"] = "Анимация для использования"
L["ANIM_COLOR"] = "Цвет/Прозрачность"
L["ANIM_COLOR_DESC"] = "Настройте цвет и прозрачность вспышки."
L["ANIM_DURATION"] = "Продолжительность"
L["ANIM_DURATION_DESC"] = "Установите, как долго будет длиться анимация после запуска."
L["ANIM_FADE"] = "Приглушить вспышки"
L["ANIM_FADE_DESC"] = "Убедитесь, что между вспышками плавное затухание. Снимите флажок, чтобы получить мгновенную вспышку."
L["ANIM_ICONALPHAFLASH"] = "Значок: альфа вспышки"
L["ANIM_ICONALPHAFLASH_DESC"] = "Вспыхивая значок меняет прозрачность, она будет чередоваться между обычной прозрачностью и настроенной для анимации."
L["ANIM_ICONBORDER"] = "Значок: Граница"
L["ANIM_ICONBORDER_DESC"] = "Накладывает цветную рамку на значок."
...
L["CLEU_SPELL_CAST_START"] = "Начало применения заклинания"
L["CLEU_SPELL_CAST_START_DESC"] = "Происходит, когда заклинание начинает произноситься. ПРИМЕЧАНИЕ. Чтобы предотвратить возможные злоупотребления, Blizzard исключила целевой отряд из этого мероприятия, поэтому вы не можете фильтровать по нему."
...
L["COLORPICKER_BRIGHTNESS"] = "Яркость "
L["COLORPICKER_BRIGHTNESS_DESC"] = "Установите яркость цвета (иногда называемую значением)."
L["COLORPICKER_OPACITY"] = "Прозрачность"
L["COLORPICKER_OPACITY_DESC"] = "Установите прозрачность цвета (иногда называемую альфа)."
L["COMPARISON"] = "Сравнение"
L["CONDITION_COUNTER"] = "Счетчик для проверки"
L["CONDITION_COUNTER_EB_DESC"] = "Введите имя счетчика, который вы хотите проверить."
L["CONDITION_QUESTCOMPLETE"] = "Квест завершен"
L["CONDITION_QUESTCOMPLETE_DESC"] = "Проверяет, выполнен ли квест."
L["CONDITION_TIMEOFDAY"] = "Время дня "
...
L["CONDITIONPANEL_ANDOR_DESC"] = "|cff7fffffНажмите|r для переключения между логическими операторами И и ИЛИ."
...
L["CONFIGPANEL_BACKDROP_HEADER"] = "Фон полосы"
L["CONFIGPANEL_CBAR_HEADER"] = "Наложение полосы таймера"
L["CONFIGPANEL_CLEU_HEADER"] = "Боевые события"
L["CONFIGPANEL_CNDTTIMERS_HEADER"] = "Таймеры условий"
L["CONFIGPANEL_COMM_HEADER"] = "Сообщение"
L["CONFIGPANEL_MEDIA_HEADER"] = "Медия"
L["CONFIGPANEL_PBAR_HEADER"] = "Наложение полосы энергии"
L["CONFIGPANEL_TIMER_HEADER"] = "Обнулить таймер"
L["CONFIGPANEL_TIMERBAR_BARDISPLAY_HEADER"] = "Полоса времени"
L["CONFIRM_DELLAYOUT"] = "Удалить макет"
...
L["DT_DOC_Opacity"] = "Возвращает прозрачность значка. Возвращаемое значение между 0 и 1."
L["DT_DOC_strfind"] = "Дает досту к функции LUA string.find для DogTags для мощных возможностей построковой обработки."
L["DT_DOC_Timer"] = "Возвращает значение таймера TellMeWhen. Таймеры создаются и изменяются с помощью значков уведомлений."
...
L["Enraged"] = "Энрейдж"
L["ERROR_ANCHOR_CYCLICALDEPS"] = "%s пытался привязаться к %s, но положение %s зависит от положения %s, поэтому TellMeWhen сбрасывает привязку на центр экрана, чтобы предотвратить катастрофический сбой."
L["ERROR_ANCHORSELF"] = "%s пытался привязаться к самому себе, поэтому TellMeWhen сбросил привязку на центр экрана, чтобы предотвратить катастрофический сбой."
...
L["EVENTHANDLER_TIMER_TAB"] = "Таймер"
L["EVENTS_CHOOSE_EVENT"] = "Выберите Триггер:"
L["EVENTS_CHOOSE_HANDLER"] = "Выберите Уведомление:"
L["EVENTS_CLONEHANDLER"] = "Клонировать"
L["EVENTS_HANDLER_ADD_DESC"] = "|cff7fffffНажмите|r чтобы добавить извещение такого типа."
L["EVENTS_HANDLERS_PLAY"] = "Тестовое уведомление"
L["EVENTS_HANDLERS_PLAY_DESC"] = "|cff7fffffНажмите|r, чтобы проверить уведомление"
...
L["EVENTS_SETTINGS_COUNTER_AMOUNT"] = "Значение"
L["EVENTS_SETTINGS_COUNTER_AMOUNT_DESC"] = "Введите сумму, на которую вы хотите установить или изменить счетчик."
L["EVENTS_SETTINGS_COUNTER_HEADER"] = "Настройки счетчика"
L["EVENTS_SETTINGS_COUNTER_NAME"] = "Имя счетчика"
L["EVENTS_SETTINGS_COUNTER_NAME_DESC"] = "Введите имя счетчика, который необходимо изменить. Если счетчик не существует при первом изменении, его начальное значение равно 0. Имена счетчиков должны быть в нижнем регистре без пробелов. Используйте это имя счетчика в других местах, где вы хотите проверить этот счетчик (условия и текстовое отображение через тег [Counter] DogTag). Опытные пользователи: счетчики хранятся в TMW.COUNTERS[counterName] = value. Вызовите TMW:Fire('TMW_COUNTER_MODIFIED', counterName), если вы измените счетчик в пользовательском скрипте Lua."
L["EVENTS_SETTINGS_COUNTER_OP"] = "Операция"
L["EVENTS_SETTINGS_COUNTER_OP_DESC"] = "Выберите операцию, которую вы хотите выполнить на счетчике"
L["EVENTS_SETTINGS_HEADER"] = "Настройки события"
L["EVENTS_SETTINGS_ONLYSHOWN"] = "Обрабатывать только, если значок отображается"
L["EVENTS_SETTINGS_ONLYSHOWN_DESC"] = "Предотвращает обработку уведомления, если значок не отображается."
L["EVENTS_SETTINGS_PASSINGCNDT"] = "Обрабатывать только в том случае, если условие проходит:"
L["EVENTS_SETTINGS_PASSINGCNDT_DESC"] = "Предотвращает обработку уведомления, если условие настроенное ниже не будет выполнено."
L["EVENTS_SETTINGS_PASSTHROUGH"] = "Понизить уведомление"
L["EVENTS_SETTINGS_PASSTHROUGH_DESC"] = "Установите этот флажок, чтобы разрешить обработку другого уведомления, вызванного событием, после этого. Если флажок не установлен, значок больше не будет обрабатывать уведомления после этого уведомления, если он что-то успешно обрабатывает и выводит/отображает. Могут быть исключения, подробности см. в описании отдельных триггеров."
L["EVENTS_SETTINGS_SIMPLYSHOWN"] = "Запускается только в том случае, если отображается значок"
L["EVENTS_SETTINGS_SIMPLYSHOWN_DESC"] = "Приводит к срабатыванию уведомления только при отображении значка. Вы можете включить этот параметр и оставить набор условий пустым, чтобы получать уведомления без каких-либо дополнительных условий. Или вы можете объединить эту настройку с дополнительными условиями."
...
L["GLOBAL_GROUP_GENERIC_DESC"] = "Группы |cff00c300Global|r доступны всем вашим профилям TellMeWhen в этой учетной записи WoW."
L["GLYPHTOCHECK"] = "Символ для проверки"
L["GROUP"] = "Группа"
L["GROUP_UNAVAILABLE"] = "|TInterface/PaperDollInfoFrame/UI-GearManager-LeaveItem-Transparent:20|t Эту группу невозможно отобразить из-за ее чрезмерно ограничительных настроек спецификации/роли."
...
L["GROUPSELECT_TOOLTIP"] = "|cff7fffffНажмите|r, чтобы отредактировать. |cff7fffffНажмите и перетащите|r, чтобы изменить порядок или изменить домен."
L["GROUPSETTINGS_DESC"] = "Настройте параметры для этой группы."
L["GUIDCONFLICT_DESC_PART1"] = "TellMeWhen обнаружил, что следующие объекты имеют одинаковый глобальный уникальный идентификатор (GUID). Это может вызвать немало проблем, если вы хотите сослаться на один из другого значка или группы (например, сделать один из них целью мета-значка). Чтобы решить эту проблему, выберите тот, для которого вы хотите создать новый GUID. Любые ссылки, которые ранее указывали на тот, который вы регенерируете, будут указывать на тот, который вы не регенерируете. Возможно, вам придется немного изменить конфигурацию, чтобы убедиться, что все работает правильно."
L["GUIDCONFLICT_DESC_PART2"] = "Если вы хотите решить эту проблему самостоятельно (например, удалив один из двух), то вы можете сделать и это."
L["GUIDCONFLICT_IGNOREFORSESSION"] = "Игнорировать конфликт для этого сеанса настройки."
L["GUIDCONFLICT_REGENERATE"] = "Восстановить GUID для %s"
L["Heals"] = "Исцеления игрока"
L["HELP_ANN_LINK_INSERTED"] = "Ссылка, которую вы только что вставили, может выглядеть странно, но именно так ее и нужно отформатировать с помощью DogTag. Изменение цветового кода при выводе на канал Blizzard приведет к разрыву ссылки."
...
L["ICONMENU_ANCHORTO"] = "Привязать к %s"
L["ICONMENU_ANCHORTO_DESC"] = "Привяжите %s к %s, чтобы при каждом движении %s двигался вместе с ним. Расширенные настройки привязки доступны в настройках группы."
L["ICONMENU_ANCHORTO_UIPARENT"] = "Сброс привязки"
L["ICONMENU_ANCHORTO_UIPARENT_DESC"] = [=[Восстанавливает анкер %s обратно на экран (Пользовательский интерфейс). В настоящее время он привязан к %s.
...
L["ICONMENU_INVERTTIMER"] = "Инвертировать затенение"
L["ICONMENU_INVERTTIMER_DESC"] = "Установите этот флажок, чтобы инвертировать эффект затенения таймера."
...
L["ICONMENU_REVERSEBARS"] = "Переворот"
L["ICONMENU_REVERSEBARS_DESC"] = "Переворачивает исходную точку слева направо."
L["ICONMENU_RUNES"] = "Восстановление руны"
L["ICONMENU_RUNES_CHARGES"] = "Непригодные для использования руны в качестве заряда"
L["ICONMENU_RUNES_CHARGES_DESC"] = "Включите эту настройку, чтобы иконка рассматривала все остывшие руны как дополнительный заряд (отображается на экране перезарядки), когда на иконке отображается используемая руна."
L["ICONMENU_RUNES_DESC"] = "Отслеживает время восстановления рун"
L["ICONMENU_SHOWCBAR_DESC"] = "Показывает полосу в нижней половине значка, на которой отображается таймер значка."
L["ICONMENU_SHOWPBAR_DESC"] = "Показывает полосу в верхней половине значка, которая показывает недостающую энергию для произнесения заклинания."
L["ICONMENU_SHOWSTACKS"] = "Показать стаки"
L["ICONMENU_SHOWSTACKS_DESC"] = "Установите этот флажок, чтобы отобразить количество стаков имеющегося у вас предмета."
L["ICONMENU_SHOWTIMER"] = "Показывать таймер"
L["ICONMENU_SHOWTIMER_DESC"] = "Установите этот флажок, чтобы на значке отображалась стандартная анимация перезарядки."
L["ICONMENU_SHOWTIMERTEXT"] = "Показать текст таймера"
L["ICONMENU_SHOWTIMERTEXT_DESC"] = "Установите этот флажок, чтобы на значке отображалось текстовое отображение оставшегося времени восстановления/длительности. Чтобы это работало, вам либо необходимо установить дополнение, такое как OmniCC, либо включить тексты таймера Blizzard в параметрах интерфейса, в категории Панели действий."
L["ICONMENU_SHOWTIMERTEXT_NOOCC"] = "Показать текст таймера ElvUI"
L["ICONMENU_SHOWTIMERTEXT_NOOCC_DESC"] = "Установите этот флажок, чтобы отобразить текстовое отображение оставшегося времени восстановления/длительности ElvUI на значке. Этот параметр влияет только на таймер ElvUI. Если у вас есть другое дополнение, предоставляющее таймеры (например, OmniCC), вы можете управлять этими таймерами с помощью настройки %q. Не рекомендуется включать обе эти настройки."
L["ICONMENU_SHOWTTTEXT_DESC2"] = "Сообщает о стаках значка как о переменной, связанной с аурой. Практическое использование включает в себя мониторинг урона щита. Это значение будет сообщено и показано вместо счетчика стаков значка. Номера предоставляются Blizzard API и не обязательно совпадают с числами, найденными во всплывающей подсказке ауры."
L["ICONMENU_SHOWTTTEXT_FIRST"] = "Первая ненулевая переменная"
L["ICONMENU_SHOWTTTEXT_FIRST_DESC"] = "Приводит к тому, что первая ненулевая переменная, связанная с баффом/дебаффом, отображается, как стаки значков. Обычно это правильная переменная, если вам нужна одна из переменных ауры."
L["ICONMENU_SHOWTTTEXT_STACKS"] = "Стаки (поведение по умолчанию)"
L["ICONMENU_SHOWTTTEXT_STACKS_DESC"] = "Приводит к тому, что стаки баффа/дебаффа отображаются, как стаки значка."
L["ICONMENU_SHOWTTTEXT_VAR"] = "Только переменная #%d"
L["ICONMENU_SHOWTTTEXT_VAR_DESC"] = "Приводит к тому, что только эта переменная сообщается как стаки значков. Используйте это, если иногда сообщается о других, неправильных переменных. Методом проб и ошибок определите, какая из переменных верна."
L["ICONMENU_SHOWTTTEXT2"] = "Переменные ауры"
L["ICONMENU_SHOWWHEN"] = "Непрозрачность и Цвет"
L["ICONMENU_SHOWWHEN_OPACITY_GENERIC_DESC"] = "Установите уровень прозрачности на котором значок должен отображаться в этом состоянии значка."
L["ICONMENU_SHOWWHEN_OPACITYWHEN_WRAP"] = "Прозрачность, когда %s|r"
...
L["ICONMENU_SPELLCAST_START_DESC"] = [=[Выберите эту опцию, если внутреннее время восстановления(iCD) начинается после произнесения заклинания |cff7fffff10|r. Вам необходимо ввести имя/идентификатор заклинания, которое запускает внутреннее время восстановления, в поле редактирования %q.


Выберите этот вариант, если внутреннее время восстановления начинается, когда: |cff7fffff1)|r Вы начинаете произносить заклинание. Вам необходимо ввести имя/идентификатор заклинания, которое запускает внутреннее время восстановления, в поле редактирования %q.]=]
...
L["ICONMENU_SPLIT_GLOBAL"] = "Разделить на новую |cff00c300global|r группу."
L["ICONMENU_SPLIT_NOCOMBAT_DESC"] = "Невозможно создавать новые группы во время боя. Выйдите из боя, чтобы разделить на новую группу."
...
L["ICONMENU_STATECOLOR"] = "Оттенок и текстура значка"
L["ICONMENU_STATECOLOR_DESC"] = "|cff7fffffНажмите|r, чтобы установить оттенок текстуры значка в этом состоянии значка. Белый - это нормально. Любой другой цвет придаст текстуре оттенок в этот цвет. Вы также можете переопределить текстуру, отображаемую на значке, находясь в этом состоянии."
L["ICONMENU_STATUE"] = "Статуя монаха"
...
L["ICONMENU_SUCCEED2"] = "Условия выполнены успешно"
L["ICONMENU_SWAPWITH"] = "Обменять с"
L["ICONMENU_SWINGTIMER"] = "Таймер замаха"
L["ICONMENU_SWINGTIMER_DESC"] = "Отслеживает таймеры замаха вашего оружия в правой и левой руке."
L["ICONMENU_SWINGTIMER_NOTSWINGING"] = "Не замах"
L["ICONMENU_SWINGTIMER_SWINGING"] = "Замах"
L["ICONMENU_TARGETTARGET"] = "Цель цели"
L["ICONMENU_TOTEM"] = "Тотем"
L["ICONMENU_TOTEM_DESC"] = "Отслеживает ваши тотемы."
L["ICONMENU_TOTEM_GENERIC_DESC"] = "Отслеживает ваши %s."
L["ICONMENU_TYPE"] = "Тип значка"
L["ICONMENU_TYPE_CANCONTROL"] = "Этот тип значка может управлять всей группой, если он установлен на первом значке группы."
L["ICONMENU_TYPE_DISABLED_BY_VIEW"] = "Этот тип значка недоступен для метода отображения %q. Измените способ отображения этой группы или создайте новую группу для использования этого типа значка."
L["ICONMENU_UIERROR"] = "Событие боевой ошибки"
L["ICONMENU_UIERROR_DESC"] = "Отслеживает сообщения об ошибках пользовательского интерфейса. Примеры включают такие вещи, как «Вы мертвы» и «У вас нет цели»."
L["ICONMENU_UNIT_DESC"] = "Введите название наблюдаемого объекта в этом поле. Названия можно выбрать из списка предложений справа, а опытные пользователи могут ввести свои. Могут быть использованы стандартные названия (например player) и/или имена игроков, с которыми вы в группе (например %s). Множественные имена объектов должны быть разделены точкой с запятой (;). Для большей информации о объектах посетите http://www.wowpedia.org/UnitId"
L["ICONMENU_UNIT_DESC_CONDITIONUNIT"] = "Введите в это поле объект для наблюдения. Название можно вставить из списка предложений справа, а опытные пользователи могут ввести свою собственную единицу измерения. Могут использоваться стандартные единицы измерения (например, игрок) и/или имена игроков, с которыми вы сгруппированы (например, %s). Для получения дополнительной информации об \"units\" посетите http://www.wowpedia.org/UnitId."
L["ICONMENU_UNIT_DESC_UNITCONDITIONUNIT"] = "Введите в это поле объект для наблюдения. Название можно выбрать из списка предложений справа. «unit» — это псевдоним для каждой единицы, которую проверяет значок."
L["ICONMENU_UNITCNDTIC"] = "Значок состояния объекта"
L["ICONMENU_UNITCNDTIC_DESC"] = "Отслеживает состояние условий на ряде объектов. Настройки, настроенные для этого значка, применяются к каждому проверяемому объекту."
L["ICONMENU_UNITCOOLDOWN"] = "Кулдаун объекта"
L["ICONMENU_UNITCOOLDOWN_DESC"] = "Отслеживает кулдауны кого-то другого. %s можно отслеживать, используя %q в качестве имени."
L["ICONMENU_UNITFAIL"] = "Условия объекта не выполнены"
L["ICONMENU_UNITS"] = "Объекты"
L["ICONMENU_UNITSTOWATCH"] = "Наблюдаемый объект"
L["ICONMENU_UNITSUCCEED"] = "Условия объекта выполнены"
L["ICONMENU_UNUSABLE"] = "Недоступно"
L["ICONMENU_UNUSABLE_DESC"] = "Это состояние активно, когда указанные выше состояния не активны. Состояния с прозрачностью равной 0% всегда будут неактивными."
L["ICONMENU_USABLE"] = "Доступно"
L["ICONMENU_USEACTIVATIONOVERLAY"] = "Проверка активации границы"
L["ICONMENU_USEACTIVATIONOVERLAY_DESC"] = "Выберите для добавления блестящей желтой границы вокруг значка, что позволит понять, что значок может быть использован."
L["ICONMENU_VALUE"] = "Отображение ресурсов"
L["ICONMENU_VALUE_DESC"] = "Отображает ресурсы (здоровье, ману и т. д.) объекта."
L["ICONMENU_VALUE_HASUNIT"] = "Объект найден"
L["ICONMENU_VALUE_NOUNIT"] = "Не найдено объектов"
L["ICONMENU_VALUE_POWERTYPE"] = "Тип ресурса"
L["ICONMENU_VALUE_POWERTYPE_DESC"] = "Настройте, какой ресурс вы хотите отслеживать с помощью значка."
L["ICONMENU_VEHICLE"] = "Средство передвижения"
L["ICONMENU_VIEWREQ"] = "Несовместимый метод отображения группы"
L["ICONMENU_VIEWREQ_DESC"] = "Этот тип значка нельзя использовать с текущим методом отображения этой группы, поскольку он не имеет необходимых компонентов для отображения всех данных. Измените метод отображения группы или создайте новую группу, чтобы использовать этот тип значков."
...
L["IconModule_IconContainer_MasqueIconContainer"] = "Контейнер значков"
L["IconModule_IconContainer_MasqueIconContainer_DESC"] = "Содержит основные части значка, например текстуру."
L["IconModule_PowerBar_OverlayPowerBar"] = "Оверлей Полосы энергии"
L["IconModule_SelfIcon"] = "Значок(Иконка)"
L["IconModule_Texture_ColoredTexture"] = "Текстура значка"
L["IconModule_TimerBar_BarDisplayTimerBar"] = "Временная шкала"
L["IconModule_TimerBar_OverlayTimerBar"] = "Оверлей Временной шкалы"
L["ICONTOCHECK"] = "Значок для проверки"
L["ICONTYPE_DEFAULT_HEADER"] = "Инструкции"
L["ICONTYPE_DEFAULT_INSTRUCTIONS"] = "Для начала выберите тип значка в раскрывающемся меню %q выше. Значки работают только тогда, когда TellMeWhen заблокирован, поэтому введите «/tmw», когда закончите. При настройке TellMeWhen обязательно читайте подсказки для каждого параметра. Эти всплывающие подсказки содержат важную информацию о том, как работают настройки!"
L["ICONTYPE_SWINGTIMER_TIP"] = "Хотите отслеживать таймер вашего %s? Тип значка %s обладает нужной вам функциональностью. Просто установите значок %s для отслеживания %q (spellID %d)! Вы также можете нажать на кнопку ниже, чтобы автоматически применить соответствующие настройки."
L["ICONTYPE_SWINGTIMER_TIP_APPLYSETTINGS"] = "Применить настройки %s"
L["IE_NOLOADED_GROUP"] = "Выберите группу для загрузки:"
L["IE_NOLOADED_ICON"] = "Значок не загружен!"
L["IE_NOLOADED_ICON_DESC"] = "Чтобы настроить значок, щелкните по нему правой кнопкой мыши. Если на вашем экране не видно значков, перейдите на вкладку %s ниже. Оттуда вы можете добавить новую группу или настроить доступность существующей группы. Введите '/ tmw', чтобы выйти из режима настройки."
L["ImmuneToMagicCC"] = "Невосприимчивый к Магии CC"
...
L["IMPORT_EXPORT_DESC"] = "Нажмите кнопку справа, чтобы импортировать и экспортировать значки, группы и профили. Для импорта в строку или из строки или экспорта другому игроку потребуется использовать это поле редактирования. Подробнее смотрите во всплывающих подсказках в раскрывающемся меню."
L["IMPORT_FAILED"] = "Импорт не удался!"
L["IMPORT_FROMBACKUP"] = "Из резервной копии"
L["IMPORT_FROMBACKUP_DESC"] = "Настройки, восстановленные из этого меню, будут такими, какими они были в: %s"
L["IMPORT_FROMBACKUP_WARNING"] = "Архив настроек: %s"
L["IMPORT_FROMCOMM"] = "От игрока"
L["IMPORT_FROMCOMM_DESC"] = "Если другой пользователь TellMeWhen отправит вам какие-либо данные конфигурации, вы сможете импортировать эти данные из этого подменю."
L["IMPORT_FROMLOCAL"] = "Из профиля"
L["IMPORT_FROMSTRING"] = "Из строки"
L["IMPORT_FROMSTRING_DESC"] = "Строки позволяют вам передавать данные конфигурации TellMeWhen за пределы игры. Чтобы выполнить импорт из строки, нажмите CTRL + V, чтобы вставить строку в поле редактирования после того, как вы скопировали ее в буфер обмена, а затем вернитесь к этому подменю."
L["IMPORT_GROUPIMPORTED"] = "Группа Импортирована!"
L["IMPORT_GROUPNOVISIBLE"] = "Группа, которую вы только что импортировали, не отображается из-за ее конфигурации, вашего текущего класса и специализации. Проверьте ее настройку в параметрах группы TMW - '/ tmw options'."
L["IMPORT_HEADING"] = "Импортировать"
L["IMPORT_ICON_DISABLED_DESC"] = "Вы должны редактировать значок, чтобы иметь возможность импортировать значок."
...
L["LAYOUTDIRECTION_PRIMARY_DESC"] = "Расширьте основное направление расположения значков в направлении %s."
...
L["LOCKED"] = "Закреплено"
L["LOCKED2"] = "Позиция заблокирована."
...
L["MiscHelpfulBuffs"] = "Разное. Полезные баффы"
L["MOON"] = "Луна"
L["MP5"] = "%d MP5"
L["MUSHROOM"] = "Гриб %d"
...
L["OPERATION_TRESTART"] = "Перезапустить"
L["OPERATION_TRESTART_DESC"] = "Сбрасывает таймер на 0 и запускает его, если он не работает."
L["OPERATION_TSTART"] = "Старт"
L["OPERATION_TSTART_DESC"] = "Запускает таймер, если он не работает. Не сбрасывает его."
...
L["PLAYER_DESC"] = "(Вы)"
L["Poison"] = "Яд"
L["PROFILE_LOADED"] = "Загруженный профиль: %с"
L["PROFILES_COPY"] = "Скопируйте профиль..."
...
L["SOUND_EVENT_ONLEFTCLICK"] = "При левом клике"
L["SOUND_EVENT_ONLEFTCLICK_DESC"] = "Это событие срабатывает, когда вы |cff7fffffЩелкаете левой кнопкой мыши|r по значку, когда значки заблокированы."
L["SOUND_EVENT_ONRIGHTCLICK"] = "При щелчке правой кнопкой мыши"
L["SOUND_EVENT_ONRIGHTCLICK_DESC"] = "Это событие срабатывает, когда вы |cff7fffffЩелкаете правой кнопкой мыши|r по значку, когда значки заблокированы."
...
L["SOUND_EVENT_ONSTART_DESC"] = "Это событие срабатывает, когда время восстановления становится непригодным для использования, накладывается бафф/дебафф эффект и т. д."
...
L["SPELL_EQUIV_REMOVE_FAILED"] = "Предупреждение: Попытка удалить %q из списка заклинаний %q, но он не был найден."
L["SPELLCHARGES"] = "Заряды заклинаний"
L["SPELLCHARGES_DESC"] = "Отслеживает заряды заклинания типа %s или %s."
L["SPELLCHARGES_FULLYCHARGED"] = "Полностью заряженный"
L["SPELLCHARGETIME"] = "Время зарядки заклинания"
L["SPELLCHARGETIME_DESC"] = "Отслеживает время, оставшееся до тех пор, пока заклинание типа %s или %s восстановит один заряд."
L["SPELLCOOLDOWN"] = "Кулдаун заклинания"
L["SPELLREACTIVITY"] = "Реактивность заклинания"
L["SPELLTOCHECK"] = "Заклинание для проверки"
L["SPELLTOCOMP1"] = "Первое Заклинание для сравнения"
L["SPELLTOCOMP2"] = "Второе заклинание для сравнения"
L["STACKALPHA_DESC"] = "Установите уровень прозрачности, на котором значок должен отображаться при сбое требований к стаку. Этот параметр будет проигнорирован, если значок уже скрыт из-за другого параметра %s."
L["STACKS"] = "Стаки"
L["STACKSPANEL_TITLE2"] = "Требования к стаку"
L["STANCE"] = "Стойка"
...
L["SUG_INSERT_RIGHT"] = "|cff7ffffffЩелкните правой кнопкой мыши|r"
...
L["SUN"] = "Солнце"
L["SWINGTIMER"] = "Таймер взмаха"
L["TEXTLAYOUTS"] = "Текстовые макеты"
L["TEXTLAYOUTS_ADDANCHOR"] = "Добавить анкер"
L["TEXTLAYOUTS_ADDANCHOR_DESC"] = "Нажмите, чтобы добавить еще одну текстовую привязку."
L["TEXTLAYOUTS_CLONELAYOUT"] = "Клонировать макет"
L["TEXTLAYOUTS_CLONELAYOUT_DESC"] = "Нажмите, чтобы создать копию этого макета, которую можно редактировать отдельно."
...
L["TEXTLAYOUTS_DELANCHOR"] = "Удалить привязку"
L["TEXTLAYOUTS_DELANCHOR_DESC"] = "Нажмите, чтобы удалить эту текстовую привязку."
L["TEXTLAYOUTS_DELETELAYOUT"] = "Удалить Расположение"
L["TEXTLAYOUTS_DESC"] = "Определите текстовые макеты, которые можно применить к любому из ваших значков."
L["TEXTLAYOUTS_ERR_ANCHOR_BADANCHOR"] = "Этот текстовый макет не работает с методом отображения этой группы. Выберите другой макет текста. (Отсутствует анкер: %s)"
L["TEXTLAYOUTS_ERR_ANCHOR_BADINDEX"] = "Ошибка макета: вывод в виде текста #%d пытается привязаться к выводу в виде текста #%d, но #%d не существует, поэтому вывод в виде текста #%d не будет работать."
...
L["TEXTLAYOUTS_TAB"] = "Отображение текста"
L["TEXTLAYOUTS_UNNAMED"] = "<без имени>"
L["TEXTLAYOUTS_USEDBY_HEADER"] = "Следующие профили используют этот макет:"
L["TEXTLAYOUTS_USEDBY_NONE"] = "Этот макет не используется ни в одном из ваших профилей TellMeWhen."
L["TOP"] = "Вверху"
L["TOPLEFT"] = "Вверху слева"
L["TOPRIGHT"] = "Вверху справа"
L["TOTEMS"] = "Тотемы для проверки"
L["TRUE"] = "Верно"
L["UIPANEL_ANCHORNUM"] = "Анкер %d"
...
L["UIPANEL_GROUPS_DROPDOWN"] = "Выберите или создайте группу..."
L["UIPANEL_GROUPS_DROPDOWN_DESC"] = "Используйте это меню для загрузки других групп и настройки или для создания новой группы. Вы также можете |cff7fffffщелкнуть правой кнопкой мыши|r по значку на экране, чтобы загрузить эту группу."
L["UIPANEL_GROUPS_GLOBAL"] = "|cff00c300Глобальные|r Группы"
L["UIPANEL_GROUPSORT"] = "Сортировка значков"
...
L["UIPANEL_GROUPSORT_shown_-1"] = "Сначала отображаются значки"
L["UIPANEL_GROUPSORT_shown_DESC"] = "Сортирует группу по тому, отображается ли значок."
L["UIPANEL_GROUPSORT_stacks"] = "Стаки"
L["UIPANEL_GROUPSORT_stacks_1"] = "Сначала низкие стаки"
L["UIPANEL_GROUPSORT_stacks_-1"] = "Сначала высокие стеки"
L["UIPANEL_GROUPSORT_stacks_DESC"] = "Сортирует группу по стакам каждого значка."
L["UIPANEL_GROUPSORT_value"] = "Значения"
L["UIPANEL_GROUPSORT_value_1"] = "Сначала низкие значения"
L["UIPANEL_GROUPSORT_value_-1"] = "Сначала высокие значения"
...
L["UIPANEL_GROUPSORT_valuep"] = "Значения в процентах"
L["UIPANEL_GROUPSORT_valuep_1"] = "Сначала низкие значения %"
L["UIPANEL_GROUPSORT_valuep_-1"] = "Сначала высокие значения %"
L["UIPANEL_GROUPSORT_valuep_DESC"] = "Сортирует группу по процентному значению индикатора выполнения. Это значение, которое предоставляет тип значка %s."
...
L["UIPANEL_WARNINVALIDS"] = "Предупреждать о неверных значках"
L["UIPANEL_WARNINVALIDS_DESC"] = "Если этот параметр включен, TellMeWhen предупредит вас, если обнаружит недопустимые конфигурации в ваших значках. НАСТОЯТЕЛЬНО РЕКОМЕНДУЕТСЯ оставить этот параметр включенным, поскольку некоторые из этих ошибок конфигурации могут привести к низкой производительности."
L["UNDO"] = "Отменить"
L["UNDO_DESC"] = "Отменить последние изменения, внесенные в настройки."
L["UNITCONDITIONS"] = "Состояние объекта"
L["UNITCONDITIONS_DESC"] = "Нажмите, чтобы настроить набор условий, которым должен соответствовать каждый объект, чтобы его можно было проверить."
L["UNITCONDITIONS_STATICUNIT"] = "<Значок объекта>"
...
L["UNITCONDITIONS_STATICUNIT_TARGET_DESC"] = "Заставляет условие проверять цель каждого объекта, которое проверяет значок."
L["UNITCONDITIONS_TAB_DESC"] = "Настройте условия так, чтобы каждая единица смогла пройти проверку."
L["UNITTWO"] = "Второй объект"
L["UNKNOWN_GROUP"] = "<Неизвестная/Недоступная группа>"
L["UNKNOWN_ICON"] = "<Значок Неизвестен / Недоступен>"
L["UNKNOWN_UNKNOWN"] = "<Неизвестный ???>"
L["UNNAMED"] = "(безымянный)"
L["UP"] = "Вверх"
L["VALIDITY_CONDITION_DESC"] = "Цель состояния"
L["VALIDITY_CONDITION2_DESC"] = "Условие #%d для"
L["VALIDITY_ISINVALID"] = "недействительно."
L["VALIDITY_META_DESC"] = "Значок #%d, отмечен мета-значком"
L["WARN_DRMISMATCH"] = "Внимание! Вы проверяете диминишинги от заклинаний из двух разных известных категорий. Все заклинания должны быть из одной категории диминишенгов, чтобы значок работал должным образом. Обнаружены следующие категории и заклинания:"
L["WATER"] = "Водa"
