...
-- Ensure defaultSettings exists before adding to it
if not DRTrackerMixin.defaultSettings then
	DRTrackerMixin.defaultSettings = { profile = {} }
end
if not DRTrackerMixin.defaultSettings.profile then
	DRTrackerMixin.defaultSettings.profile = {}
end
