...
L["Attention! Update interval shorter than 15 seconds may cause the game to run slow and impact your gaming experience!!!"] =
	"Achtung! Ein Aktualisierungsintervall kleiner als 15 Sekunden kann dazu führen, dass das Spiel nicht mehr so rund läuft und dadurch dein Spielerlebnis beeinträchtigt wird."
...
L["By hiding the window you can activate background search so you can do anything else in the game."] =
	"Durch das Verstecken des Fensters kannst du die Hintergrundsuche aktivieren, um andere Dinge im Spiel zu machen."
L["Click [+] to open window within extended features."] =
	"Klicke auf [+], um das Fenster innerhalb der erweiterten Funktionen zu öffnen"
L["Defeated"] = "Besiegt"
L["Define minimum and/or maximum number of players of any role."] =
	"Definiere die minimale und/oder maximale Anzahl an Spielern für eine bestimmte Rolle."
...
L["Enter the words you want to be present or absent in group title and comment."] =
	"Gib die Wörter ein, die im Gruppentitel und Kommentar vorhanden sein sollen oder auch nicht vorkommen sollen."
...
L["For example if you are a tank you can set maximum number of tanks to 1 and you get the groups you are guaranteed to have a spot."] =
	"Zum Beispiel: Wenn du ein Tank bist, kannst du die maximale Anzahl an Tanks auf 1 setzen und du bekommst Gruppen, wo du garantiert einen Platz hast."
...
L["If a group is not created by the addon this option is ignored."] =
	"Diese Option wird ignoriert, wenn eine Gruppe nicht über das Addon erstellt wird."
L["If you want to join a group of highly equipped characters you can setup minimum item level defined for its members."] =
	"Wenn du eine Gruppe mit gut ausgestatteten Spielern erstellen willst, kannst du eine Mindestgegenstandsstufe für die Mitglieder festsetzen."
...
L["Select group activity: quest, dungeon, raid, difficulty"] =
	"Wähle die Gruppenaktivität: Quest, Dungeon, Raid, Schwierigkeitsgrad"
...
L["The addon notifies you if it finds a group that matches your requirements."] =
	"Das Addon verständigt dich, wenn es eine Gruppe nach deinen Anforderungen findet."
L["The filters take effect when you click this button. The changes don't take effect until you do that."] =
	"Der Filter wird aktiv, sobald du den Button klickst. Die Änderungen treten erst danach in Kraft."
...
L["Works only on premades created with Premade Filter addon"] =
	"Funktioniert nur mit Gruppen, die über das Addon Premade Filter erstellt wurden"
L["You can find a group that uses specific voice chat software or a group tha doesn't use voice chat at all."] =
	"Du kannst eine Gruppe suchen, die eine bestimmte Sprachchat Software verwenden oder eine Gruppe, die keinen Sprachchat verwendet."
L["You can mark the bosses you want to be still alive with [v] and the bosses you want to be already defeated by [-]."] =
	"Du kannst die Bosse markieren, die noch am Leben sein sollen mit [v] und Bosse, die bereits besiegt sein sollen mit [-]."
