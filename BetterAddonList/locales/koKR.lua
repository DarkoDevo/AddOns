...
L["Addon List"] = "애드온 목록"
L["Create new set"] = "새 세트 만들기"
L["Delete"] = "삭제"
L["Delete set %s?"] = "%s 세트를 삭제할까요?"
L["Deleted set %q."] = "%q 세트를 삭제했습니다."
L["Disable addons from this set"] = "이 세트에서 애드온 비활성화"
L["Disable all addons then enable addons in this set."] = "모든 애드온을 비활성화한 다음 이 세트의 애드온을 활성화합니다."
L["Disabled addons in set %q."] = "%q 세트의 애드온이 비활성화되었습니다."
L["Disabled all addons."] = "모든 애드온을 비활성화했습니다."
...
L["Enter the name for the new set"] = "새 세트의 이름을 입력하세요."
