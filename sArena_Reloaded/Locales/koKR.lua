...
L["Widget_ArenaTargetIndicators"] = "투기장 대상 표시기"
L["Widget_PartyTargetsOnArena_Enable"] = "투기장 프레임에 파티 대상 표시"
L["Widget_PartyTargetsOnArena_Desc"] = "파티원이 대상을 지정하는 투기장 프레임에 직업 색상 아이콘을 표시합니다."
L["Widget_ArenaTargetsOnParty_Enable"] = "파티 프레임에 투기장 대상 표시"
L["Widget_ArenaTargetsOnParty_Desc"] = "투기장 상대가 대상을 지정하는 파티 프레임에 직업 색상 아이콘을 표시합니다."
L["Widget_PartyOnArena"] = "투기장 프레임의 파티 대상"
L["Widget_ArenaOnParty"] = "파티 프레임의 투기장 대상"
L["Widget_Spacing"] = "간격"
L["Widget_ArenaTargetIndicators_Enable"] = "투기장 대상 표시기 활성화"
L["Widget_ArenaTargetIndicators_Desc"] = "아래의 모든 투기장/파티 대상 표시기 기능의 마스터 토글"
...
L["Option_ImportExport"] = "프로필 공유" --needsUpdate
...
L["Option_ImportExport_Desc"] = "sArena 프로필 내보내기 또는 가져오기" --needsUpdate
...
L["Option_ImportProfile_Desc_Website"] = "%s의 프로필 설정을 가져옵니다.\n\n%s%s|r"
