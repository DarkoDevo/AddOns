...
data.version={
	nodes_version = 685,  -- Increase this when working on the nodes. Connections will be baked automatically when committing.
}
...
["Sunkiller Sanctum"] = {[0]=2540, [1]=2528,},
...
-- Caves
	...
	{"Isle of Quel Danas (Intro)/0","Isle of Quel Danas (Intro)/1"},	-- Inro maps
	{"Isle of Quel Danas (Intro)/0","Isle of Quel Danas (Intro)/2"},	-- Inro maps
	{"Isle of Quel Danas (Intro)/1","Isle of Quel Danas (Intro)/2"},	-- Inro maps
...
data.RemapData = {
	...
	[619] = { -- broken island 
		...
		{top=-1132.8970947266, bottom=-1384.7160644531, left=4669.2470703125, right=4417.4267578125, target=627, cond=function() return ZGV.IsLegionRemix() end },
	},
