...
data.portkeys = { -- smile if you're a muggle
	...
	{item=141605, destination="_TAXIWHISTLE", cost=15, toy=true, cooldown=60, mode="whistle", cond=function() return ZGV.LibRover.TaxiWhistlePredictor:IsOnValidMap() end }, -- Flight Master's Whistle
	...
	{spell=265225, destination="Mount Hyjal/0 57.18,77.11", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53601) end, title="Use your Mole Machine and select Kalimdor, then Throne of Flame."},

	-- Mole Machine, The Great Divide
	{spell=265225, destination="Southern Barrens/0 39.11,9.30", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53600) end, title="Use your Mole Machine and select Kalimdor, then The Great Divide."},
	
	-- Mole Machine, Fire Plume Ridge
	{spell=265225, destination="Un'Goro Crater/0 52.88,55.76", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53591) end, title="Use your Mole Machine and select Kalimdor, then Fire Plume Ridge."},
	
	-- Mole Machine, Stormwind City
	{spell=265225, destination="Stormwind City/0 63.33,37.34", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() end, title="Use your Mole Machine and select Eastern Kingdoms, then Stormwind City."},
	
	-- Mole Machine, Ironforge
	{spell=265225, destination="Dun Morogh/0 61.29,37.18", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() end, title="Use your Mole Machine and select Eastern Kingdoms, then Ironforge."},
	
	-- Mole Machine, Shadowforge City
	{spell=265225, destination="Shadowforge City/0 61.44,24.35", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() end, title="Use your Mole Machine and select Eastern Kingdoms, then Shadowforge City."},
	
	-- Mole Machine, Nethergarde Keep
	{spell=265225, destination="Blasted Lands/0 61.97,12.80", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53594) end, title="Use your Mole Machine and select Eastern Kingdoms, then Nethergarde Keep."},
	
	-- Mole Machine, Aerie Peak
	{spell=265225, destination="The Hinterlands/0 13.53,46.80", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53585) end, title="Use your Mole Machine and select Eastern Kingdoms, then Aerie Peak."},
	
	-- Mole Machine, The Masonary
	{spell=265225, destination="Burning Steppes/16 33.30,24.80", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53587) end, title="Use your Mole Machine and select Eastern Kingdoms, then The Masonary."},
	
	-- Mole Machine, Fel Pits
	{spell=265225, destination="Shadowmoon Valley/0 50.77,35.30", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53599) end, title="Use your Mole Machine and select Outland, then Fel Pits."},
	
	-- Mole Machine, Skald
	{spell=265225, destination="Blade's Edge Mountains/0 72.42,17.64", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53597) end, title="Use your Mole Machine and select Outland, then Skald."},
	
	-- Mole Machine, Ruby Dragonshrine
	{spell=265225, destination="Dragonblight/0 45.35,49.92", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53596) end, title="Use your Mole Machine and select Northrend, then Ruby Dragonshrine."},
	
	-- Mole Machine, Argent Tournament Grounds
	{spell=265225, destination="Icecrown/0 76.97,18.66", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53586) end, title="Use your Mole Machine and select Northrend, then Argent Tournament Grounds."},
	
	-- Mole Machine, Stormstout Brewery
	{spell=265225, destination="Valley of the Four Winds/0 31.51,73.59", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53598) end, title="Use your Mole Machine and select Pandaria, then Stormstout Brewery."},
	
	-- Mole Machine, One Keg
	{spell=265225, destination="Kun-Lai Summit/0 57.68,62.81", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53595) end, title="Use your Mole Machine and select Pandaria, then One Keg."},
	
	-- Mole Machine, Blackrock Foundry Overlook
	{spell=265225, destination="Gorgrond/0 46.69,38.76", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53588) end, title="Use your Mole Machine and select Draenor, then Blackrock Foundry Overlook."},
	
	-- Mole Machine, Elemental Plateau
	{spell=265225, destination="Nagrand D/0 65.75,8.25", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53590) end, title="Use your Mole Machine and select Draenor, then Elemental Plateau."},
	
	-- Mole Machine, Neltharion's Vault
	{spell=265225, destination="Highmountain/0 44.66,72.90", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53593) end, title="Use your Mole Machine and select Broken Isles, then Neltharion's Vault."},
	
	-- Mole Machine, Broken Shore
	{spell=265225, destination="Broken Shore/0 71.69,47.99", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(53589) end, title="Use your Mole Machine and select Broken Isles, then Broken Shore."},

	-- Zalamar Invasion, Zandalar
	{spell=265225, destination="Nazmir/0 34.34,45.13", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(80099) end, title="Use your Mole Machine and select Zandalar, then Zalamar Invasion."},	

	-- Xibala Incursion, Zandalar
	{spell=265225, destination="Zuldazar/0 38.24,72.37", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(80100) end, title="Use your Mole Machine and select Zandalar, then Xibala Incursion."},	

	-- Tidebreak Summit, Kul Tiras
	{spell=265225, destination="Stormsong Valley/0 64.22,29.44", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(80102) end, title="Use your Mole Machine and select Kul Tiras, then Tidebreak Summit."},	

	-- Wailing Tideways, Kul Tiras
	{spell=265225, destination="Tiragarde Sound/0 88.22,71.53", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(80101) end, title="Use your Mole Machine and select Kul Tiras, then Wailing Tideways."},

	-- The Eternal Forge, The Shadowlands
	{spell=265225, destination="Bastion/0 51.75,13.12", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(80105) end, title="Use your Mole Machine and select The Shadowlands, then The Eternal Forge."},	

	-- Soryn's Meadow, The Shadowlands
	{spell=265225, destination="Ardenweald/0 66.46,50.57", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(80106) end, title="Use your Mole Machine and select The Shadowlands, then Soryn's Meadow."},	

	-- Scorched Crypt, The Shadowlands
	{spell=265225, destination="Revendreth/0 19.91,38.78", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(80104) end, title="Use your Mole Machine and select The Shadowlands, then Scorched Crypt."},	

	-- Valley of a Thousand Legs, The Shadowlands
	{spell=265225, destination="Maldraxxus/0 53.51,59.78", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(80103) end, title="Use your Mole Machine and select The Shadowlands, then Valley of a Thousand Legs."},

	-- Obsidian Rest, Dragon Isles
	{spell=265225, destination="Zaralek Cavern/0 52.71,27.67", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(80109) end, title="Use your Mole Machine and select Dragon Isles, then Obsidian Rest."},

	-- Vakthros Summit, Dragon Isles
	{spell=265225, destination="The Azure Span/0 80.09,38.97", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(80108) end, title="Use your Mole Machine and select Dragon Isles, then Vakthros Summit."},

	-- The Slagmire, Dragon Isles
	{spell=265225, destination="The Waking Shores/0 32.36,54.90", cost=90, cooldown=1800, cond=function() return not ZGV.Parser.ConditionEnv.indoors() and IsQuestFlaggedCompleted(80107) end, title="Use your Mole Machine and select Dragon Isles, then The Slagmire."},
	...
	-- Key to the Arcantina
		{item=253629, toy=true, destination="Arcantina/0 50.61,88.88", cost=15, cooldown=90, cond=function() return ZGV.CurrentMapID~=2541 end}, -- world to arcantina
		{item=253629, toy=true, destination="@arcantina_exit", cost=15, cooldown=90, cond=function() return ZGV.CurrentMapID==2541 end}, -- arcantina to world, destination is dynamic
