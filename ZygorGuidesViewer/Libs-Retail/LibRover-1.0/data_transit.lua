...
---------------------
		...
		---------------------------
			--## ALLIANCE ##--
				...
				-- Silvermoon City -to- Stormwind City
					...
					"{cond:PlayerCompletedQuest(86852) or ZGV.Parser.ConditionEnv.achieved(41806)}",
			...
			--## Neutral ##--
				...
				-- Silvermoon City -to- Harandar
					...
					"{cond:ZGV.Parser.ConditionEnv.achieved(41804)}",
				...
				-- Silvermoon City -to- Voidstorm
					...
					"{cond:ZGV.Parser.ConditionEnv.achieved(41806) or PlayerCompletedQuest(86510) or PlayerIsOnQuest(86510)}",
		...
		--------------------
			...
			--## Neutral ##--
				...
				-- Harandar -to- Silvermoon City (The Den)
					...
					"{title:Click the Eversong Rootway\nInside The Den}"..
					"{cond:ZGV.Parser.ConditionEnv.achieved(41804) or PlayerCompletedQuest(86899) or PlayerIsOnQuest(86899)}",
				...
				-- Harandar -to- Voidstorm (The Den)
					...
					"{title:Click the Portal to Voidstorm\nInside The Den}"..
					"{cond:ZGV.Parser.ConditionEnv.achieved(41806)}",
					--"{cond:PlayerCompletedQuest(86899) or PlayerIsOnQuest(86899)}",
	...
	--## Neutral ##--
		...
		"Dalaran L/10 47.56,70.31 -x- Dalaran L/10 46.48,113.78 {mode:PORTAL} {title_atob:Click the Portal to the Infinite Bazaar} {cost:3}"..			-- Legion Remix Dalaran Island Portal
			"{title_btoa:Click the Portal to Dalaran} {cond:PlayerCompletedQuest(91962) and ZGV.IsLegionRemix()}",
	...
	--## Neutral ##--
		...
		"{cond:(PlayerIsOnQuest(83137) or PlayerCompletedQuest(83137) or ZGV.Parser.ConditionEnv.achieved(40900,1)) and PlayerLevel() >= 80}",
		...
		"{cond:(PlayerIsOnQuest(83151) or PlayerCompletedQuest(83151) or ZGV.Parser.ConditionEnv.achieved(40900,1)) and PlayerLevel() >= 80}",
		...
		"{cond:(PlayerIsOnQuest(83933) or PlayerCompletedQuest(83933) or ZGV.Parser.ConditionEnv.achieved(40900,1)) and PlayerLevel() >= 80}",
	...
	--## HORDE ##--
		...
		"Undercity/0 85.25,17.04 -to- Hellfire Peninsula/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10 and ZGV.InPhase('Old Undercity')}",
			...
			"Tirisfal Glades L/0 69.45,62.80 -to- Silvermoon City/0 49.49,14.80 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
			...
			"Tirisfal Glades L/0 69.45,62.80 -to- Northern Stranglethorn/0 37.23,50.48 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades L/0 69.45,62.80 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades L/0 69.45,62.80 -to- Howling Fjord/0 79.00,28.92 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades L/0 69.45,62.80 -to- Hellfire Peninsula/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Undercity) --CHECKED
			"Tirisfal Glades L/0 69.45,62.80 -to- Undercity/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Silvermoon City) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Silvermoon City/0 49.49,14.80 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Grom'gol) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Northern Stranglethorn/0 37.23,50.48 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Howling Fjord/0 79.00,28.92 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Hellfire Peninsula/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Undercity) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Undercity/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",
	...
	--## NEUTRAL ##--
		...
		--"{cond:not ZGV:RaceClassMatch('MAGE')}",
	...
	--## ALLIANCE ##--		
		...
		"Tiragarde Sound/0 74.38,23.41 -to- The Exodar/0 47.62,59.82 {fac:A} {mode:PORTAL} {title:Click the Portal to Exodar Inside the Building} {cond:ZGV.InPhase('BFA') or PlayerLevel() >= 50}}",

		-- Sanctum of the Sages - Boralus Harbor, Tiragarde Sound -to- Ironforge - Dun Morogh, Eastern Kingdoms --
		"Tiragarde Sound/0 74.49,23.50 -to- Ironforge/0 25.51,8.43 {fac:A} {mode:PORTAL} {title:Click the Portal to Ironforge Inside the Building} {cond:ZGV.InPhase('BFA') or PlayerLevel() >= 50}}",
		...
		"Boralus/0 70.13,16.79 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind Inside the Building} "..
			"{cond:ZGV.InPhase('BFA') or PlayerLevel() >= 50}",
	...
	--## HORDE ##--
		...
		"Dazar'alor/1 73.99,62.22 -to- Silvermoon City/0 58.26,19.24 {fac:H} {mode:PORTAL} {title:Click the Portal to Silvermoon City Inside the Building} {cond:ZGV.InPhase('BFA') or PlayerLevel() >= 50}",

		-- Hall of Ancient Paths - Zuldazar, Zandalar -to- Orgrimmar - Durotar, Kalimdor --
		"Dazar'alor/1 74.05,69.75 -to- @org_tp_dst {fac:H} {mode:PORTAL} {title:Click the Portal to Orgrimmar Inside the Building} {cond:ZGV.InPhase('BFA') or PlayerLevel() >= 50}",

		-- Hall of Ancient Paths - Zuldazar, Zandalar -to- Thunder Bluff - Mulgore, Kalimdor --
		"Dazar'alor/1 73.60,77.38 -to- Thunder Bluff/0 22.21,16.87 {fac:H} {mode:PORTAL} {title:Click the Portal to Thunder Bluff Inside the Building} {cond:ZGV.InPhase('BFA') or PlayerLevel() >= 50}",
...
------------------
		...
		-- MONK (Zen Pilgrimage)
			"The Wandering Isle L/0 51.46,48.65 <spell:126892> <subtype:zenpilgrimage> <cond:PlayerCompletedQuest(40236) and ZGV.CurrentMapID~=709>",
