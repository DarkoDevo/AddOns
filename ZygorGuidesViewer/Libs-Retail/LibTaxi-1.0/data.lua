...
data.taxipoints[994]={				-- CHANGED, USED TO BE 905
	['Krokuun']={
		{name="Vindicaar, Krokuun",faction="B",x=42.58,y=22.78,f=1,taxioperator="argusportal",argushub=true, known_fun=function() return LibTaxi:AnyTaxiKnown(1928,1967,1976) or ZGV.Parser.ConditionEnv.completedq(47224) end},
	...
	['Eredath']={
		{name="Vindicaar, Eredath",faction="B",x=48.98,y=23.13,f=3,taxioperator="argusportal",argushub=true, known_fun=function() return LibTaxi:AnyTaxiKnown(1977,1978,1982,1991,2003) or ZGV.Parser.ConditionEnv.completedq(48081) end}, 
	...
	['Antoran Wastes']={
		{name="Vindicaar, Antoran Wastes",faction="B",x=32.32,y=56.57,f=5,taxioperator="argusportal",argushub=true, known_fun=function() return LibTaxi:AnyTaxiKnown(1988,1992,1993) or ZGV.Parser.ConditionEnv.completedq(48199) end}, 
...
data.taxipoints[1978]={
	...
	['The Waking Shores']={
		...
		{name="Skytop Observatory",faction="B",npc="Ancient Waygate",npcid="aw",x=75.28,y=57.02,taxinodeID=2841,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=ZGV.Parser.ConditionEnv return (c.readyq(71157) or c.completedq(71157)) and not c.hasbuff(392960) end},
		{name="Rubyscale Outpost", faction="B",npc="Ancient Waygate",npcid="aw",x=47.28,y=90.30,taxinodeID=2842,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=ZGV.Parser.ConditionEnv return (c.readyq(70156) or c.completedq(70156)) and not c.hasbuff(392960) end},
	},
	...
	['Ohn\'ahran Plains']={
		...
		{name="Rusza'thar Reach",faction="B",npc="Ancient Waygate",npcid="aw",x=81.31,y=38.98,taxinodeID=2839,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=ZGV.Parser.ConditionEnv return (c.readyq(71138) or c.completedq(71138)) and not c.hasbuff(392960) end},
		{name="Shady Sanctuary", faction="B",npc="Ancient Waygate",npcid="aw",x=30.66,y=55.48,taxinodeID=2840,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=ZGV.Parser.ConditionEnv return (c.readyq(71178) or c.completedq(71178)) and not c.hasbuff(392960) end},
	...
	['The Azure Span']={
		...
		{name="Cobalt Assembly",faction="B",npc="Ancient Waygate",npcid="aw",x=48.33,y=30.13,taxinodeID=2838,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=ZGV.Parser.ConditionEnv return (c.readyq(70156) or c.completedq(70156)) and not c.hasbuff(392960) end},
		{name="Vakthros",       faction="B",npc="Ancient Waygate",npcid="aw",x=77.59,y=30.79,taxinodeID=2837,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=ZGV.Parser.ConditionEnv return (c.readyq(71161) or c.completedq(71161)) and not c.hasbuff(392960) end},
	...
	['Thaldraszus']={
		...
		{name="Algeth'era",  faction="B",npc="Ancient Waygate",npcid="aw",x=62.42,y=40.47,taxinodeID=2836,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=ZGV.Parser.ConditionEnv return (c.readyq(71162) or c.completedq(71162)) and not c.hasbuff(392960) end},
		{name="Eon's Fringe",faction="B",npc="Ancient Waygate",npcid="aw",x=52.34,y=78.54,taxinodeID=2834,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=ZGV.Parser.ConditionEnv return (c.readyq(71165) or c.completedq(71165)) and not c.hasbuff(392960) end},
	},
	...
	['The Forbidden Reach/5']={ -- The Forbidden Reach/5
		...
		{name="Morqut Islet",faction="B",npc="Ancient Waygate",npcid="aw",x=29.08,y=62.45,taxinodeID=2862,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=ZGV.Parser.ConditionEnv return (c.readyq(75154) or c.completedq(75154)) and not c.hasbuff(392960) end},
	},
...
local function is_phase_conduit_available()
	return ZGV.Parser.ConditionEnv.hasbuff(1214374)
	--return ZGV.Parser.ConditionEnv.completedq(89561)
end
...
data.taxipoints[2274]={
	...
	['Tazavesh']={ 
		{name="Tazavesh",faction="B",npc="Om'thenai",npcid=234692,x=34.75,y=10.03,taxinodeID=3029,cond_fun=function() return not ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
	...
	['K\'aresh']={ 
		-- NEUTRAL --
		{name="Hosaas' Rest",faction="B",npc="Om'Dodaf",npcid=234701,x=54.21,y=62.83,taxinodeID=3035,cond_fun=function() return not ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="Eco-Dome: Rhovan",faction="B",npc="Om'Toya",npcid=234722,x=70.19,y=60.91,taxinodeID=3030,cond_fun=function() return not ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="The Oasis",faction="B",npc="Om'Khell",npcid=234718,x=76.66,y=34.94,taxinodeID=3031,cond_fun=function() return not ZGV.Parser.ConditionEnv.hasbuff(1214374) end},--3146
		{name="Shan'dorah",faction="B",npc="Sellyna",npcid=234721,x=60.61,y=29.20,taxinodeID=3032,cond_fun=function() return not ZGV.Parser.ConditionEnv.hasbuff(1214374) end},--3147
		{name="Overlook Zo'Shuul",faction="B",npc="Om'Qaxxi",npcid=234724,x=47.81,y=37.26,taxinodeID=3034,cond_fun=function() return not ZGV.Parser.ConditionEnv.hasbuff(1214374) end},--3157
		{name="Shadow Point",faction="B",npc="Lossain",npcid=234719,x=42.24,y=22.71,taxinodeID=3033,cond_fun=function() return not ZGV.Parser.ConditionEnv.hasbuff(1214374) end},--3155
		-- NEUTRAL --
