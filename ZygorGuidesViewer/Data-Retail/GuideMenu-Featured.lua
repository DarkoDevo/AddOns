...
{"section", text=[[PETSMOUNTS]]},
	...
	{"guideslist", content=[[Ground Mounts]],filters={patch="110200", mounts="*", mounttype={"Ground"}},columns=4},
	{"guideslist", content=[[Flying Mounts]],filters={patch="110200", mounts="*", mounttype={"Flying"}},columns=4},
	{"guideslist", content=[[Aquatic Mounts]],filters={patch="110200", mounts="*", mounttype={"Aquatic"}},columns=4},

	{"guideslist", content=[[Battle Pets - Source: Achievement]],filters={patch="110200", source="Achievement"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Black Market]],filters={patch="110200", source="BlackMarket"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Drop]],filters={patch="110200", source="Drop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: In-Game Shop]],filters={patch="110200", source="In-GameShop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Pet Battles]],filters={patch="110200", source="PetBattle"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Professions]],filters={patch="110200", source="Profession"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Promotions]],filters={patch="110200", source="Promotion"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Quest]],filters={patch="110200", source="Quest"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Trading Card Game]],filters={patch="110200", source="TradingCardGame"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Unknown]],filters={patch="110200", source="unknown"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Vendor]],filters={patch="110200", source="Vendor"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: World Events]],filters={patch="110200", source="WorldEvent"},columns=4},
}) 
...
{"section", text=[[PETSMOUNTS]]},
	...
	{"guideslist", content=[[Ground Mounts]],filters={patch="110105", mounts="*", mounttype={"Ground"}},columns=4},
	{"guideslist", content=[[Flying Mounts]],filters={patch="110105", mounts="*", mounttype={"Flying"}},columns=4},
	{"guideslist", content=[[Aquatic Mounts]],filters={patch="110105", mounts="*", mounttype={"Aquatic"}},columns=4},

	{"guideslist", content=[[Battle Pets - Source: Achievement]],filters={patch="110105", source="Achievement"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Black Market]],filters={patch="110105", source="BlackMarket"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Drop]],filters={patch="110105", source="Drop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: In-Game Shop]],filters={patch="110105", source="In-GameShop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Pet Battles]],filters={patch="110105", source="PetBattle"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Professions]],filters={patch="110105", source="Profession"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Promotions]],filters={patch="110105", source="Promotion"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Quest]],filters={patch="110105", source="Quest"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Trading Card Game]],filters={patch="110105", source="TradingCardGame"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Unknown]],filters={patch="110105", source="unknown"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Vendor]],filters={patch="110105", source="Vendor"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: World Events]],filters={patch="110105", source="WorldEvent"},columns=4},

{"section", text=[[ACHIEVEMENTS]]},
	{"banner", image=ZGV.IMAGESDIR.."Patch110105Achievements",showcaseonly=true},

	{"guideslist", filters={patch="110105", source="*"},columns=4},
}) 
...
{"section", text=[[PETSMOUNTS]]},
	...
	{"guideslist", content=[[Ground Mounts]],filters={patch="110100", mounts="*", mounttype={"Ground"}},columns=4},
	{"guideslist", content=[[Flying Mounts]],filters={patch="110100", mounts="*", mounttype={"Flying"}},columns=4},
	{"guideslist", content=[[Aquatic Mounts]],filters={patch="110100", mounts="*", mounttype={"Aquatic"}},columns=4},

	{"guideslist", content=[[Battle Pets - Source: Achievement]],filters={patch="110100", source="Achievement"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Black Market]],filters={patch="110100", source="BlackMarket"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Drop]],filters={patch="110100", source="Drop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: In-Game Shop]],filters={patch="110100", source="In-GameShop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Pet Battles]],filters={patch="110100", source="PetBattle"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Professions]],filters={patch="110100", source="Profession"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Promotions]],filters={patch="110100", source="Promotion"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Quest]],filters={patch="110100", source="Quest"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Trading Card Game]],filters={patch="110100", source="TradingCardGame"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Unknown]],filters={patch="110100", source="unknown"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Vendor]],filters={patch="110100", source="Vendor"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: World Events]],filters={patch="110100", source="WorldEvent"},columns=4},

{"section", text=[[ACHIEVEMENTS]]},
	{"banner", image=ZGV.IMAGESDIR.."TWWAchievements",showcaseonly=true},

	{"guideslist", filters={patch="110100", source="*"},columns=4},
}) 
...
{"section", text=[[PETSMOUNTS]]},
	...
	{"guideslist", content=[[Ground Mounts]],filters={patch="110007", mounts="*", mounttype={"Ground"}},columns=4},
	{"guideslist", content=[[Flying Mounts]],filters={patch="110007", mounts="*", mounttype={"Flying"}},columns=4},
	{"guideslist", content=[[Aquatic Mounts]],filters={patch="110007", mounts="*", mounttype={"Aquatic"}},columns=4},

	{"guideslist", content=[[Battle Pets - Source: Achievement]],filters={patch="110007", source="Achievement"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Black Market]],filters={patch="110007", source="BlackMarket"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Drop]],filters={patch="110007", source="Drop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: In-Game Shop]],filters={patch="110007", source="In-GameShop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Pet Battles]],filters={patch="110007", source="PetBattle"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Professions]],filters={patch="110007", source="Profession"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Promotions]],filters={patch="110007", source="Promotion"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Quest]],filters={patch="110007", source="Quest"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Trading Card Game]],filters={patch="110007", source="TradingCardGame"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Unknown]],filters={patch="110007", source="unknown"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Vendor]],filters={patch="110007", source="Vendor"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: World Events]],filters={patch="110007", source="WorldEvent"},columns=4},

{"section", text=[[ACHIEVEMENTS]]},
	{"banner", image=ZGV.IMAGESDIR.."TWWAchievements",showcaseonly=true},

	{"guideslist", filters={patch="110007", source="*"},columns=4},
}) 
...
{"section", text=[[PETSMOUNTS]]},
	...
	{"guideslist", content=[[Aquatic Mounts]],filters={patch="110002", mounts="*", mounttype={"Aquatic"}},columns=4},

	{"guideslist", content=[[Battle Pets - Source: Achievement]],filters={patch="110002", source="Achievement"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Black Market]],filters={patch="110002", source="BlackMarket"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Drop]],filters={patch="110002", source="Drop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: In-Game Shop]],filters={patch="110002", source="In-GameShop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Pet Battles]],filters={patch="110002", source="PetBattle"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Professions]],filters={patch="110002", source="Profession"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Promotions]],filters={patch="110002", source="Promotion"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Quest]],filters={patch="110002", source="Quest"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Trading Card Game]],filters={patch="110002", source="TradingCardGame"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Unknown]],filters={patch="110002", source="unknown"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Vendor]],filters={patch="110002", source="Vendor"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: World Events]],filters={patch="110002", source="WorldEvent"},columns=4},

{"section", text=[[ACHIEVEMENTS]]},
	{"banner", image=ZGV.IMAGESDIR.."TWWAchievements",showcaseonly=true},

	{"guideslist", filters={patch="110002", source="*"},columns=4},
}) 
...
{"section", text=[[PETSMOUNTS]]},
	...
	{"guideslist", content=[[Ground Mounts]],filters={patch="100207", mounts="*", mounttype={"Ground"}},columns=4},
	{"guideslist", content=[[Flying Mounts]],filters={patch="100207", mounts="*", mounttype={"Flying"}},columns=4},
	{"guideslist", content=[[Aquatic Mounts]],filters={patch="100207", mounts="*", mounttype={"Aquatic"}},columns=4},

	{"guideslist", content=[[Battle Pets - Source: Achievement]],filters={patch="100207", source="Achievement"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Black Market]],filters={patch="100207", source="BlackMarket"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Drop]],filters={patch="100207", source="Drop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: In-Game Shop]],filters={patch="100207", source="In-GameShop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Pet Battles]],filters={patch="100207", source="PetBattle"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Professions]],filters={patch="100207", source="Profession"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Promotions]],filters={patch="100207", source="Promotion"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Quest]],filters={patch="100207", source="Quest"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Trading Card Game]],filters={patch="100207", source="TradingCardGame"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Unknown]],filters={patch="100207", source="unknown"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Vendor]],filters={patch="100207", source="Vendor"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: World Events]],filters={patch="100207", source="WorldEvent"},columns=4},

{"section", text=[[ACHIEVEMENTS]]},
	{"banner", image=ZGV.IMAGESDIR.."DragonflightAchievements",showcaseonly=true},

	{"guideslist", filters={patch="100207", source="*"},columns=4},
}) 
...
{"section", text=[[PETSMOUNTS]]},
	...
	{"guideslist", content=[[Ground Mounts]],filters={patch="100205", mounts="*", mounttype={"Ground"}},columns=4},
	{"guideslist", content=[[Flying Mounts]],filters={patch="100205", mounts="*", mounttype={"Flying"}},columns=4},
	{"guideslist", content=[[Aquatic Mounts]],filters={patch="100205", mounts="*", mounttype={"Aquatic"}},columns=4},

	{"guideslist", content=[[Battle Pets - Source: Achievement]],filters={patch="100205", source="Achievement"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Black Market]],filters={patch="100205", source="BlackMarket"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Drop]],filters={patch="100205", source="Drop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: In-Game Shop]],filters={patch="100205", source="In-GameShop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Pet Battles]],filters={patch="100205", source="PetBattle"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Professions]],filters={patch="100205", source="Profession"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Promotions]],filters={patch="100205", source="Promotion"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Quest]],filters={patch="100205", source="Quest"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Trading Card Game]],filters={patch="100205", source="TradingCardGame"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Unknown]],filters={patch="100205", source="unknown"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Vendor]],filters={patch="100205", source="Vendor"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: World Events]],filters={patch="100205", source="WorldEvent"},columns=4},

{"section", text=[[ACHIEVEMENTS]]},
	{"banner", image=ZGV.IMAGESDIR.."DragonflightAchievements",showcaseonly=true},

	{"guideslist", filters={patch="100205", source="*"},columns=4},
}) 
...
{"section", text=[[PETSMOUNTS]]},
	...
	{"guideslist", content=[[Ground Mounts]],filters={patch="100200", mounts="*", mounttype={"Ground"}},columns=4},
	{"guideslist", content=[[Flying Mounts]],filters={patch="100200", mounts="*", mounttype={"Flying"}},columns=4},
	{"guideslist", content=[[Aquatic Mounts]],filters={patch="100200", mounts="*", mounttype={"Aquatic"}},columns=4},

	{"guideslist", content=[[Battle Pets - Source: Achievement]],filters={patch="100200", source="Achievement"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Black Market]],filters={patch="100200", source="BlackMarket"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Drop]],filters={patch="100200", source="Drop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: In-Game Shop]],filters={patch="100200", source="In-GameShop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Pet Battles]],filters={patch="100200", source="PetBattle"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Professions]],filters={patch="100200", source="Profession"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Promotions]],filters={patch="100200", source="Promotion"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Quest]],filters={patch="100200", source="Quest"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Trading Card Game]],filters={patch="100200", source="TradingCardGame"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Unknown]],filters={patch="100200", source="unknown"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Vendor]],filters={patch="100200", source="Vendor"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: World Events]],filters={patch="100200", source="WorldEvent"},columns=4},

{"section", text=[[ACHIEVEMENTS]]},
	{"banner", image=ZGV.IMAGESDIR.."DragonflightAchievements",showcaseonly=true},

	{"guideslist", filters={patch="100200", source="*"},columns=4},
}) 
...
{"section", text=[[PETSMOUNTS]]},
	...
	{"guideslist", content=[[Ground Mounts]],filters={patch="100107", mounts="*", mounttype={"Ground"}},columns=4},
	{"guideslist", content=[[Flying Mounts]],filters={patch="100107", mounts="*", mounttype={"Flying"}},columns=4},
	{"guideslist", content=[[Aquatic Mounts]],filters={patch="100107", mounts="*", mounttype={"Aquatic"}},columns=4},

	{"guideslist", content=[[Battle Pets - Source: Achievement]],filters={patch="100107", source="Achievement"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Black Market]],filters={patch="100107", source="BlackMarket"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Drop]],filters={patch="100107", source="Drop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: In-Game Shop]],filters={patch="100107", source="In-GameShop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Pet Battles]],filters={patch="100107", source="PetBattle"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Professions]],filters={patch="100107", source="Profession"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Promotions]],filters={patch="100107", source="Promotion"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Quest]],filters={patch="100107", source="Quest"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Trading Card Game]],filters={patch="100107", source="TradingCardGame"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Unknown]],filters={patch="100107", source="unknown"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Vendor]],filters={patch="100107", source="Vendor"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: World Events]],filters={patch="100107", source="WorldEvent"},columns=4},

{"section", text=[[ACHIEVEMENTS]]},
	{"banner", image=ZGV.IMAGESDIR.."DragonflightAchievements",showcaseonly=true},

	{"guideslist", filters={patch="100107", source="*"},columns=4},
}) 
...
{"section", text=[[PETSMOUNTS]]},
	...
	{"guideslist", content=[[Aquatic Mounts]],filters={patch="100105", mounts="*", mounttype={"Aquatic"}},columns=4},

	{"guideslist", content=[[Battle Pets - Source: Achievement]],filters={patch="100105", source="Achievement"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Black Market]],filters={patch="100105", source="BlackMarket"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Drop]],filters={patch="100105", source="Drop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: In-Game Shop]],filters={patch="100105", source="In-GameShop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Pet Battles]],filters={patch="100105", source="PetBattle"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Professions]],filters={patch="100105", source="Profession"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Promotions]],filters={patch="100105", source="Promotion"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Quest]],filters={patch="100105", source="Quest"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Trading Card Game]],filters={patch="100105", source="TradingCardGame"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Unknown]],filters={patch="100105", source="unknown"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Vendor]],filters={patch="100105", source="Vendor"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: World Events]],filters={patch="100105", source="WorldEvent"},columns=4},

{"section", text=[[ACHIEVEMENTS]]},
	{"banner", image=ZGV.IMAGESDIR.."DragonflightAchievements",showcaseonly=true},

	{"guideslist", filters={patch="100105", source="*"},columns=4},
}) 
...
{"section", text=[[PETSMOUNTS]]},
	...
	{"guideslist", content=[[Ground Mounts]],filters={patch="100100", mounts="*", mounttype={"Ground"}},columns=4},
	{"guideslist", content=[[Flying Mounts]],filters={patch="100100", mounts="*", mounttype={"Flying"}},columns=4},
	{"guideslist", content=[[Aquatic Mounts]],filters={patch="100100", mounts="*", mounttype={"Aquatic"}},columns=4},

	{"guideslist", content=[[Battle Pets - Source: Achievement]],filters={patch="100100", source="Achievement"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Black Market]],filters={patch="100100", source="BlackMarket"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Drop]],filters={patch="100100", source="Drop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: In-Game Shop]],filters={patch="100100", source="In-GameShop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Pet Battles]],filters={patch="100100", source="PetBattle"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Professions]],filters={patch="100100", source="Profession"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Promotions]],filters={patch="100100", source="Promotion"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Quest]],filters={patch="100100", source="Quest"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Trading Card Game]],filters={patch="100100", source="TradingCardGame"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Unknown]],filters={patch="100100", source="unknown"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Vendor]],filters={patch="100100", source="Vendor"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: World Events]],filters={patch="100100", source="WorldEvent"},columns=4},

{"section", text=[[ACHIEVEMENTS]]},
	{"banner", image=ZGV.IMAGESDIR.."DragonflightAchievements",showcaseonly=true},

	{"guideslist", filters={patch="100100", source="*"},columns=4},
}) 
...
{"section", text=[[PETSMOUNTS]]},
	...
	{"guideslist", content=[[Aquatic Mounts]],filters={patch="100002", mounts="*", mounttype={"Aquatic"}},columns=4},

	{"guideslist", content=[[Battle Pets - Source: Achievement]],filters={patch="100002", source="Achievement"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Black Market]],filters={patch="100002", source="BlackMarket"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Drop]],filters={patch="100002", source="Drop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: In-Game Shop]],filters={patch="100002", source="In-GameShop"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Pet Battles]],filters={patch="100002", source="PetBattle"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Professions]],filters={patch="100002", source="Profession"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Promotions]],filters={patch="100002", source="Promotion"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Quest]],filters={patch="100002", source="Quest"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Trading Card Game]],filters={patch="100002", source="TradingCardGame"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Unknown]],filters={patch="100002", source="unknown"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: Vendor]],filters={patch="100002", source="Vendor"},columns=4},
	{"guideslist", content=[[Battle Pets - Source: World Events]],filters={patch="100002", source="WorldEvent"},columns=4},

{"section", text=[[ACHIEVEMENTS]]},
	{"banner", image=ZGV.IMAGESDIR.."DragonflightAchievements",showcaseonly=true},

	{"guideslist", filters={patch="100002", source="*"},columns=4},
}) 
