...
ItemScore.rules = {
	...
	["DEMONHUNTER"] = {
		...
		[3] = { -- DEVOURER-DPS
			itemtypes={ WARGLAIVE=1, FIST=1, AXE=1, SWORD=1, LEATHER=1 },
			stats = { INTELLECT=2.66, MASTERY=1.0, HASTE=0.85, CRIT=0.75, VERSATILITY=0.4, EMPTY_SOCKET_DOMINATION=0.25, EMPTY_SOCKET_PRISMATIC=0.25, STAMINA=0.01, ARMOR=0.01 },
