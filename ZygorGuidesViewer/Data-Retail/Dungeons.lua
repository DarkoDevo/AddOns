...
Dungeons.hardcoded_dungeons = {
	["e_751_14"] = {expansionLevel=2, minLevel=50, difficulty=14, name="The Black Temple"},
	["e_742_3"] = {expansionLevel=2, minLevel=50, difficulty=14, name="Blackwing Lair"},
	["e_78_14"] = {expansionLevel=2, minLevel=50, difficulty=14, name="Firelands"},
	["e_78_15"] = {expansionLevel=2, minLevel=50, difficulty=14, name="Firelands"},
	["e_741_3"] = {expansionLevel=2, minLevel=50, difficulty=3, name="Molten Core"},
	["e_752_4"] = {expansionLevel=2, minLevel=50, difficulty=4, name="Sunwell Plateau"},
	["e_744_3"] = {expansionLevel=2, minLevel=50, difficulty=3, name="Temple of Ahn'Qiraj"},
	["e_255_2"] = {expansionLevel=2, minLevel=50, difficulty=2, name="The Black Morass"},
	["e_749_2"] = {expansionLevel=2, minLevel=50, difficulty=4, name="The Eye"},
	["e_759_14"] = {expansionLevel=2, minLevel=50, difficulty=14, name="Ulduar"},

	-- mythic mop
	["e_313_23"] = {expansionLevel=4, minLevel=70, difficulty=23, name="Temple of the Jade Dragon"},

	-- mythic legion
	["e_777_23"]  = {expansionLevel=6, minLevel=50, difficulty=23, name="Assault on Violet Hold"},
	["e_740_23"]  = {expansionLevel=6, minLevel=50, difficulty=23, name="Black Rook Hold"},
	["e_800_23"]  = {expansionLevel=6, minLevel=50, difficulty=23, name="Court of Stars"},
	["e_762_23"]  = {expansionLevel=6, minLevel=50, difficulty=23, name="Darkheart Thicket"},
	["e_716_23"]  = {expansionLevel=6, minLevel=50, difficulty=23, name="Eye of Azshara"},
	["e_721_23"]  = {expansionLevel=6, minLevel=50, difficulty=23, name="Halls of Valor"},
	["e_727_23"]  = {expansionLevel=6, minLevel=50, difficulty=23, name="Maw of Souls"},
	["e_767_23"]  = {expansionLevel=6, minLevel=50, difficulty=23, name="Neltharion's Lair"},
	["e_726_23"]  = {expansionLevel=6, minLevel=50, difficulty=23, name="The Arcway"},
	["e_707_23"]  = {expansionLevel=6, minLevel=50, difficulty=23, name="Vault of the Wardens"},
	["e_860_23"]  = {expansionLevel=6, minLevel=50, difficulty=23, name="Return to Karazhan"},
	["e_900_23"]  = {expansionLevel=6, minLevel=50, difficulty=23, name="Cathedral of Eternal Night"},
	["e_945_23"]  = {expansionLevel=6, minLevel=50, difficulty=23, name="Seat of the Triumvirate"},
	-- mythic battle for azeroth
	["e_968_23"]   = {expansionLevel=7, minLevel=50, difficulty=23, name="Atal'Dazar"},
	["e_1001_23"]  = {expansionLevel=7, minLevel=50, difficulty=23, name="Freehold"},
	["e_1041_23"]  = {expansionLevel=7, minLevel=50, difficulty=23, name="Kings' Rest"},
	["e_1036_23"]  = {expansionLevel=7, minLevel=50, difficulty=23, name="Shrine of the Storm"},
	["e_1023_23"]  = {expansionLevel=7, minLevel=50, difficulty=23, name="Siege of Boralus"},
	["e_1030_23"]  = {expansionLevel=7, minLevel=50, difficulty=23, name="Temple of Sethraliss"},
	["e_1012_23"]  = {expansionLevel=7, minLevel=50, difficulty=23, name="The MOTHERLODE!!"},
	["e_1022_23"]  = {expansionLevel=7, minLevel=50, difficulty=23, name="The Underrot"},
	["e_1002_23"]  = {expansionLevel=7, minLevel=50, difficulty=23, name="Tol Dagor"},
	["e_1021_23"]  = {expansionLevel=7, minLevel=50, difficulty=23, name="Waycrest Manor"},
	--["e_1178"]  = {expansionLevel=7, minLevel=120, min_ilevel=310, difficulty=23, name="Operation: Mechagon",  },

	["e_1023_1"]  = {expansionLevel=7, minLevel=50, difficulty=1, name="Siege of Boralus"},

	["e_1296_15"] = {expansionLevel=10, minLevel=80, difficulty=15, name="Liberation of Undermine"}, 
	["e_1296_16"] = {expansionLevel=10, minLevel=80, difficulty=16, name="Liberation of Undermine"}, 
	["e_1273_15"] = {expansionLevel=10, minLevel=80, difficulty=15, name="Nerub-ar Palace"}, 
	["e_1273_16"] = {expansionLevel=10, minLevel=80, difficulty=16, name="Nerub-ar Palace"}, 
	["e_1302_15"] = {expansionLevel=10, minLevel=80, difficulty=15, name="Manaforge Omega"}, 
	["e_1302_16"] = {expansionLevel=10, minLevel=80, difficulty=16, name="Manaforge Omega"}, 


	-- world bosses
	["e_322_14"]  = {expansionLevel=4, minLevel=50,  difficulty=14, name="World Bosses"},
	["e_557_14"]  = {expansionLevel=5, minLevel=50,  difficulty=14, name="World Bosses"},
	["e_833_14"]  = {expansionLevel=6, minLevel=50,  difficulty=14, name="World Bosses"},
	["e_1028_14"] = {expansionLevel=7, minLevel=50,  difficulty=14, name="World Bosses"}, 
	["e_1192_14"] = {expansionLevel=8, minLevel=50,  difficulty=14, name="World Bosses"}, 
	["e_1205_14"] = {expansionLevel=9, minLevel=60,  difficulty=14, name="World Bosses"}, 
	["e_1278_14"] = {expansionLevel=10, minLevel=70, difficulty=14, name="World Bosses"}, 

	-- mythic+
	["e_1023_8"]  = {expansionLevel=7, minLevel=80, difficulty=8, name="Siege of Boralus"},
	["e_71_8"]  =   {expansionLevel=3, minLevel=80, difficulty=8, name="Grim Batol"},
}
