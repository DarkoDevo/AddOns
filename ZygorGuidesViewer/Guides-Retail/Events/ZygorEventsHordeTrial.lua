...
ZygorGuidesViewer:RegisterGuide("Events Guides\\Lunar Festival\\Achievements\\Elders of Khaz Algar",{
condition_suggested=function() return isevent('Lunar Festival') end,
achieveid={41130},
patch='110007',
...
ZygorGuidesViewer:RegisterGuidePlaceholder("Events Guides\\Midsummer Fire Festival\\Midsummer Fire Festival Achievements\\The Fires of Azeroth\\Flame Keeper of Khaz Algar")
