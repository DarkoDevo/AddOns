...
Select _"I'd like to see what you have to offer this month."_
...
Select _"We need explorers for an expedition to the Dragon Isles. Will you join us?"_
Recruit the Explorers |q 65443/2 |goto Orgrimmar/1 38.60,56.95
step
talk Boss Magor##184787
|tip On the ground, on the fishing dock.
Select _"We need artisans for an expedition to the Dragon Isles. Will you join us?"_
Recruit the Artisans |q 65443/1 |goto Orgrimmar/1 57.10,54.11
step
Enter the building |goto Orgrimmar/1 70.36,49.01 < 10 |walk |only if not (subzone("The Wyvern's Tail") and _G.IsIndoors())
talk Cataloger Coralie##184795
|tip Upstairs inside the building.
Select _"We need scholars for an expedition to the Dragon Isles. Will you join us?"_
Recruit the Scholars |q 65443/3 |goto Orgrimmar/1 71.45,50.63
step
talk Kodethi##198442
|tip On top of the wall.
Select _"Scalecommander Cindrethresh would like you to meet her at the zeppelin tower."_
Deliver the Orders to Kodethi |q 72256/1 |goto Orgrimmar/1 55.08,89.61
step
...
talk Archmage Khadgar##193450
|tip On top of the tower.
Select _"<Ask Khadgar what happened.>"_
